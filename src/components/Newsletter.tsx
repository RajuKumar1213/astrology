    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-purple-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-600 mb-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-purple-100 p-3 rounded-full">
                  <GiCompass className="text-2xl text-purple-600" />
                </div>
                <div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-50 rounded-2xl p-8 border border-purple-200">
