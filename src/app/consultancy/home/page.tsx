...
const HomeConsultancyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-white to-pink-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                  ...
                  <span className="text-purple-600"> Sacred Sanctuary</span>
                </h1>
            ...
            <div className="relative">
              ...
              {/* Background Gradient */}
              <div className="absolute inset-0 bg-gradient-to-br from-purple-200/30 to-pink-200/30 rounded-2xl transform rotate-3 -z-10"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Fill out the form below and our expert will contact you for a personalized consultation
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Covered Area (Sq ft) *</label>
                <input
                  type="text"
                  name="area"
                  value={formData.area}
