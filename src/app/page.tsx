...
const VastuBenefits = () => {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-purple-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                ...
                <span className="block text-purple-600">Ancient Vastu Wisdom</span>
              </h2>
            ...
            <div className="pt-4">
              <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105">
          ...
          <div className="relative">
            ...
            {/* Floating stats */}
            <div className="absolute top-8 -left-8 bg-white p-4 rounded-xl shadow-lg border border-purple-100">
